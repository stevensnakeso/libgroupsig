...
int sltgs23_claim(groupsig_proof_t *proof, groupsig_key_t *memkey, 
  ...
  /*   LOG_EINVAL(&logger, __FILE__, "sltgs23_claim", __LINE__, LOGERROR); */
  /*   return IERROR; */
  /* } */
  ...
  /* rc = sltgs23_prove_equality(proof, memkey, grpkey, sigs, 1); */
