...
#ifndef _SLTGS23_BLINDSIG_H
#define _SLTGS23_BLINDSIG_H
...
/**
 * @struct sltgs23_blindsig_t
 * @brief Defines the structure of a blinded SLTGS23 signature.
 * Defineme.
 */
typedef struct {
...
/** 
 * @fn groupsig_blindsig_t* sltgs23_signature_init()
...
/** 
 * @fn int sltgs23_blindsig_free(groupsig_blindsig_t *sig)
...
/** 
 * @fn int sltgs23_blindsig_copy(groupsig_blindsig_t *dst, 
...
/** 
 * @fn int sltgs23_blindsig_to_string(groupsig_blindsig_t *sig)
...
/** 
 * @fn int sltgs23_blindsig_get_size(groupsig_blindsig_t *sig)
...
/** 
 * @fn int sltgs23_blindsig_export(byte_t **bytes,
 *			        uint32_t *size,
 *		       	        groupsig_blindsig_t *sig)
 * @brief Exports the specified signature into an array of bytes.
 * The format will be:
 *
 *    | SLTGS23_CODE | sizeof(nym1) | nym1 | sizeof(nym2) | nym2 | sizeof(nym3) | nym3 | 
...
/** 
 * @fn groupsig_blindsig_t* sltgs23_blindsig_import(byte_t *source, uint32_t size)
...
/**
 * @var sltgs23_blindsig_handle
 * @brief Set of functions for managing SLTGS23 signatures.
 */
static const groupsig_blindsig_handle_t sltgs23_blindsig_handle = {
  .scheme = GROUPSIG_SLTGS23_CODE, /**< The scheme code. */
  .init = &sltgs23_blindsig_init,  /**< Initializes signatures. */
  .free = &sltgs23_blindsig_free, /**< Frees signatures. */
  .copy = &sltgs23_blindsig_copy, /**< Copies signatures. */
  .get_size = &sltgs23_blindsig_get_size, /**< Gets the size in bytes of a signature. */
  .gexport = &sltgs23_blindsig_export, /**< Exports signatures. */
  .gimport = &sltgs23_blindsig_import, /**< Imports signatures. */
  .to_string = &sltgs23_blindsig_to_string, /**< Converts signatures to printable strings. */
};
